// ========== DQX日課チェッカー（修正版：セクション背景・z-index・【】配置改善） ==========
(function(global) {
// ===== ストレージキー =====
    ...
    for (let item of sectionsTemplate) {
        if (item.type === 'section') {
            ...
            if (nextText) {
                ...
                nextSpan.style.marginLeft = '0px';
                nextSpan.innerText = nextText;
                leftDiv.appendChild(nextSpan);
            }
...
thead tr th:first-child { position: sticky; left: 0; background-color: #e6edf4; z-index: 10; }
tbody tr td:first-child { position: sticky; left: 0; background-color: #fafcff; z-index: 9; }
.task-name { font-weight: 600; text-align: left; padding-left: 6px; white-space: nowrap; font-size: 0.7rem; }

/* セクション行：より強い背景色 */
.section-row { background: #c9d5e8 !important; border-top: 2px solid #9db3d1; border-bottom: 2px solid #9db3d1; }
.section-row td { color: #1a2a47 !important; font-weight: bold; font-size: 0.65rem; padding: 4px 8px !important; }
.detail-section-row td { background: #c9d5e8; font-weight: bold; }
...
body.dark-mode tbody tr td:first-child { background: #111827 !important; z-index: 9; }
body.dark-mode thead tr th:first-child { background: #1f2937 !important; z-index: 10; }
body.dark-mode .section-row { background: #2a3d54 !important; border-top: 2px solid #445566; border-bottom: 2px solid #445566; }
body.dark-mode .section-row td { color: #ffffff !important; font-weight: bold; }
body.dark-mode .detail-section-row td { background: #2a3d54; }
